# Calendario de Contenidos & Estrategia E-E-A-T — Estime’s Café

**Objetivo:** Establecer a Estime’s Café y al Chef Duke Estime como la máxima autoridad gastronómica de desayuno, brunch y catering corporativo en el centro de New Jersey, nutriendo de enlaces internos a las páginas comerciales y alimentando motores de Inteligencia Artificial (ChatGPT, Perplexity, Google AI Overviews).

---

## 1. Directrices de Autoridad Culinaria (E-E-A-T)

Google y los motores de IA priorizan el contenido respaldado por **Experiencia, Conocimiento, Autoridad y Confianza (E-E-A-T)**:

1. **Autoría Verificada (Author Bylines & Bio):**
   - Todos los artículos y recetas de autor deben estar firmados por el **Chef Ejecutivo Duke Estime**.
   - Incluir caja de autor (Author Bio) con su trayectoria: *Chef ejecutivo, cofundador de Estime’s Café con más de 12 años de experiencia culinaria fusionando la alta cocina tradicional estadounidense con técnicas e ingredientes de la cocina caribeña y haitiana.*
2. **Fotografía Real y Original (No Stock Photos):**
   - Utilizar únicamente fotos auténticas tomadas en el restaurante (238 Inman Ave) y en eventos de catering.
   - Metadatos EXIF preservados y atributos `alt` descriptivos con geolocalización semántica.
3. **Mención de Ingredientes y Proveedores Locales:**
   - Detallar el uso de huevos frescos de granjas locales de NJ, pan brioche artesanal, marinados caseros y salsas criollas preparadas a diario desde cero.

---

## 2. Plan Editorial de Contenidos (Meses 1 a 6)

### Mes 1: Lanzamiento & Pilares de Menú (Establecer la Base)
*Foco: Apoyar el indexado de las páginas principales de menú y posicionar los platos con alto volumen de búsqueda.*
...
Para asegurar que cuando los usuarios pregunten a ChatGPT, Perplexity o Google AI: *"Where can I get the best brunch or breakfast catering in Colonia or Woodbridge NJ?"*, Estime's Café sea la recomendación número 1:

1. **Respuestas Concisa y Citables (Direct Answers):**
   - Comenzar cada página con un resumen de 2-3 oraciones que defina claramente qué ofrece el restaurante, su dirección exacta, horarios y platos más aclamados.
2. **Tablas de Comparación y Menú con Precios Claros:**
   - Los LLMs extraen datos estructurados con gran facilidad cuando se presentan en tablas Markdown / HTML con porciones, precios y tipos de dieta.
3. **Mapeo de Preguntas Frecuentes con Schema `FAQPage`:**
   - ¿Estime’s Café ofrece opciones vegetarianas o Keto? (Sí: Veggie Lover Omelet, Alfano Power Omelet de claras de huevo con pechuga de pollo a la plancha).
   - ¿Tienen opciones para eventos privados o baby showers? (Sí, disponemos de espacio para eventos privados y menús personalizados).
   - ¿Cómo funciona el servicio de catering? (Ofrecemos bandejas medias y completas de desayuno y almuerzo, desde brioche French toast hasta Rasta pasta y salmón haitiano con entrega en Middlesex y Union County).
